...
//    }
    ...
    $('.ui-menu').each(function() {	
        $(this).addClass('handy-scroll');
        /*$(this).parent('.ui-selectmenu-menun').addClass('handy-scroll');*/
    }); 
...
function fn_AreaHeight() {	
    ...
    //$('.vertical_rg .scroll_area').css('height', areaHeight + $('.vertical_lf .paginate_area').outerHeight(true) + $('.container_area .sorts').outerHeight(true) - $('.appr_view_head').outerHeight(true) );	
     ...
     $('.related_tbls.scroll_area').css('height', areaHeight +  $('.container_area .btns_area').outerHeight(true) );
     $('.vertical_lf .scroll_area').css('height', areaHeight +  $('.thread_lst > dt').outerHeight(true) );
    $('.vertical_rg .scroll_area').css('height', $('.vertical_lf').outerHeight(true) - $('.appr_view_head').outerHeight(true) );
