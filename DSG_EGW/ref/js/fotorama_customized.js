...
fotoramaVersion = "4.6.4",
	function (a, b, c, d, e) {
		...
		function B(a, b, c) {
			var e, f, g = a.video;
			return "youtube" === g.type ? (f = y() + g.id + "/default.jpg", 
                                           e = f.replace(/\/default.jpg$/, "/hqdefault.jpg"), 
                                           a.thumbsReady = !0) : "vimeo" === g.type ? d.ajax({
				url: y() + g.id + ".json", dataType: "jsonp",
				success: function (d) {
					a.thumbsReady = !0, C(b, {
		...
		function I(a, b, c, d) {
			var e = a.data(), // img 데이터
				f = e.measures; // img 데이터의 값들
			...
			if  (f && (!e.l || e.l.W !== f.width || e.l.H !== f.height || e.l.r !== f.ratio || e.l.w !== b.w || e.l.h !== b.h || e.l.m !== c || e.l.p !== d)) {
                ...
                if ( a.outerWidth() < a.outerHeight()) { // 세로형 이미지                    
                    a.css({
					width: g,
					height: i,
					left: p(o.x, b.w - g),
			        ...
			        if ( 530 < a.outerHeight() ) { 
                       a.css({ height: 530 });  // 높이값에 530입력
                        
                    }                     
            } else { // 가로형 이미지 
                
			        if ( 767 < a.outerWidth() ) { 
                       a.css({ width: 767 });  // 가로값에 767입력
                        
                        if ( 530 < a.outerHeight() ) { // 가로형 이미지이지만, 높이가 530보다 큰 경우
                       a.css({ height: 530 });  // 높이값에 530입력                        
                    }   
                    } 
                }      
